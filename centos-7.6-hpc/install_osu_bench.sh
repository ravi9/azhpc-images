...
mkdir -p /mnt/shared/osu-bench-openmpi                                                                                                                                                        
cd /mnt/shared/osu-bench-openmpi/                                                                                                                                                             
...
./configure CC=/opt/openmpi-4.0.0/bin/mpicc CXX=/opt/openmpi-4.0.0/bin/mpicxx --prefix=/opt/osu/                                                                                            
make -j                                                                                                                                                                                       
make install 
